...
def analyze_image(img: Image, dictVariables: dict):
 dictVariablesString = json.dumps(dictVariables, ensure_ascii=False)
 prompt = (
   ...
   f"Here is a dictionary of user-assigned variables. If the given expression has any of these variables, use its actual value from this dictionary accordingly: {dictVariablesString}. "
